...
export function AdminRoutes() {
  return (
    <Routes>
      ...
      <Route path="/login" element={<AppShell authenticated={false}><LoginPage /></AppShell>} />
      <Route path="/auth/consume" element={<AppShell authenticated={false}><MagicLinkConsumePage /></AppShell>} />
